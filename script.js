// ... (startSession, fixSession ja bufferToWav jäävad samaks nagu eelmises töötavas versioonis) ...
    ...
    tx.objectStore("sessions").getAll().onsuccess = e => {
        ...
        document.getElementById('history-container').innerHTML = list.map(s => `
            <div class="glass rounded-[30px] p-5 space-y-4 shadow-xl border border-white/5 text-left">
                <div class="flex justify-between items-center text-[10px] uppercase tracking-tight">
...
// ... (dl, delS ja toB64 jäävad samaks) ...
